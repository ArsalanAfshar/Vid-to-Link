...
MESSAGES: dict[str, str] = {
    ...
    "error_youtube_bot_check": (
        "🤖 **خطای تأیید هویت یوتیوب (Sign in / Bot Challenge)**\n\n"
        "سرور یوتیوب به دلیل موقعیت دیتاسنتری هاستینگ (Railway/Cloud)، این درخواست ناشناس را مسدود کرده است.\n\n"
        "💡 **راه‌حل‌های رفع مشکل:**\n"
        "1️⃣ **ارسال مستقیم کوکی:** مدیر ربات می‌تواند فایل `cookies.txt` را مستقیماً برای همین ربات ارسال کند.\n"
        "2️⃣ **تنظیم در ریل‌وی:** فایل کوکی را به صورت Base64 در متغیر `YOUTUBE_COOKIES_B64` قرار دهید:\n"
        "`base64 -w 0 cookies.txt`\n"
        "3️⃣ **استخراج کوکی:** با افزونه «Get cookies.txt LOCALLY» در مرورگر و در حالت Private/Incognito وارد حساب یوتیوب شده و کوکی‌ها را دانلود نمایید."
    ),
